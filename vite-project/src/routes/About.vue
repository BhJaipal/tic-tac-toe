<template>
	<v-card>
		<v-tabs v-model="tabs" align-tabs="end" color="deep-purple-accent-4">
						...
						<v-bottom-sheet inset>
							...
							<v-card>
								...
								<v-card-text
									...
									quisquam fuga rerum esse quas labore facilis
									nostrum at.</v-card-text
								>
							</v-card>
						</v-bottom-sheet>
